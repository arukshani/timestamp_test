...
int main(int argc, char **argv)
{
    ...
    // printf("HWTSTAMP_FILTER_PTP_V2_L4_SYNC: %d \n", HWTSTAMP_FILTER_PTP_V2_L4_SYNC);
    // printf("HWTSTAMP_FILTER_PTP_V1_L4_SYNC: %d \n", HWTSTAMP_FILTER_PTP_V1_L4_SYNC);
    // printf("HWTSTAMP_FILTER_NONE: %d \n", HWTSTAMP_FILTER_NONE);
    // printf("ptpv2: %d \n", ptpv2);
    // printf("so_timestamping.flags & SOF_TIMESTAMPING_RX_HARDWARE: %d \n", so_timestamping.flags & SOF_TIMESTAMPING_RX_HARDWARE);
